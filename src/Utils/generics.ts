...
// [PATCH] Version fallback quando `fetchLatestWaWebVersion` FALHA.
// Deve sempre refletir a versão mais recente estável aceita pelo WA hoje —
// sem isso, quando o fetch falha (proxy sem TLS, CDN Meta flapando), cai num
// valor velho e WA rejeita com `statusCode: 405` (protocol outdated) em loop.
// Atualizado em 2026-04-24 pra bater com o `Defaults/index.ts` e `baileys-version.json`.
const baileysVersion = [2, 3000, 1038024963]
import type {
	BaileysEventEmitter,
	BaileysEventMap,
	ConnectionState,
