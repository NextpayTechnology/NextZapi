...
type Templatable = {
	/**
	 * botões de template (reply / url / call). Gera
	 * templateMessage.fourRowTemplate no WhatsApp. Não combine com `buttons`
...
type Listable = {
	/** seções da lista (required para listMessage) */
	sections?: proto.Message.ListMessage.ISection[]
	/** título que aparece acima do botão de abrir lista */
	title?: string
	/** label do botão que abre a lista (required quando sections está presente) */
	buttonText?: string
}
